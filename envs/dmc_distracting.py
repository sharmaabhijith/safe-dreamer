...
class DistractingControl(gym.Env):
    ...
    def _obs_from_timestep(self, time_step):
        ...
        # distracting_control adds a "pixels" key when pixels_only=False;
        # render our own image at the configured size for consistency.
        obs.pop("pixels", None)
    ...
    def _render(self):
        # Use distracting_control's physics (which already has distractors applied)
